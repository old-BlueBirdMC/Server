...
export default class MovePlayerPacketHandler extends HandlersBase {
    async startHandling(packet) {
        ...
        if ((x >> 4) / this.player.chunkRadius != (this.player.position.x >> 4) / this.player.chunkRadius || (z >> 4) / this.player.chunkRadius != (this.player.position.z >> 4) / this.player.chunkRadius) {
